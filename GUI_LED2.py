...
class LEDControlGUI:
    ...
    def create_widgets(self):
        ...
        self.ip_label = ttk.Label(self.root, text="Enter NodeMCU IP:", background="#f0f0f0")
    ...
    def create_button_styles(self):
        ...
        ttk.Style().configure('Connect.TButton', background='#00cc00', foreground='white')  # Connect button style
